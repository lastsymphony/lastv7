...
module.exports = msgHandler = async (bocchi = new Client(), message) => {
    try {
        ...
        if (isGroupMsg && isAutoStickerOn && isMedia && isImage && !isCmd) {
            ...
            await bocchi.sendImageAsSticker(from, imageBase64, { author: '@Aditya jatayu', pack: 'symphony', keepScale: false })
        ...
        if (isGroupMsg && isAutoStickerOn && isMedia && isVideo && !isCmd) {
            ...
            await bocchi.sendMp4AsSticker(from, videoBase64, null, { stickerMetadata: true, pack: 'symphony', author: '@Aditya jatayu', fps: 30, startTime: '00:00:00.0', endTime : '00:00:05.0', crop: false, loop: 0 })
            console.log(`Sticker processed for ${processTime(t, moment())} seconds`)
        }
        ...
        switch (command) {
            case 'antiporn': // Premium, chat VideFikri
                await bocchi.reply(from, 'Premium Feature!\n\nContact: wa.me/6289670394574?text=Buy%20Anti%20Porn', id)
            break
